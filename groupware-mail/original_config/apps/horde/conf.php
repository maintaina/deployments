...
$conf['use_ssl'] = 2;
$conf['server']['name'] = $_SERVER['SERVER_NAME'] ?? 'horde.dev.local';
...
$conf['sql']['password'] = 'H0rdePasSS_chang3May';
...
$conf['log']['name'] = '/srv/www/horde/var/log/horde.log';
...
$conf['mailer']['params']['host'] = 'horde81horde_postfix';
